...
bool ImGui::Tab(const char* icon, const char* label, bool selected)
{
    ...
    window->DrawList->AddRectFilled(pos, ImVec2(pos.x + 2, pos.y + size.y), ImColor(100, 150, 255, int(255 * it_filled->second)));
    ...
    ImGui::GetForegroundDrawList()->AddText(ImVec2(bb.Min.x + (34 / 2), bb.Min.y + (12 - label_size.y / 2)), ImColor(255, 255, 255), icon);
...
bool ImGui::beginchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRect(pos - ImVec2(2, 2), p + size_arg + ImVec2(2, 2), ImColor(231, 97, 223, int(155 * alpha)), 0);
    ...
    parent_window->DrawList->AddRect(pos, p + size_arg, ImColor(231, 97, 223, int(255 * alpha)), 0);


    parent_window->DrawList->AddText(pos + ImVec2(6, 3), ImColor(231, 97, 223), name);
    ...
    parent_window->DrawList->AddLine(p + ImVec2(1, 8), p + ImVec2(200, 8), ImColor(231, 97, 223, int(255 * alpha)));
    return ret;
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const float size = GetWindowWidth() - 35;
