...
namespace ImGui
{
    ...
    IMGUI_API bool          FirstChild(const char* str_id, const ImVec2& size_arg = ImVec2(0, 0), bool sub_tab = false, ImGuiWindowFlags extra_flags = NULL);
    // Content region
    // 

    IMGUI_API bool          Firstchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    IMGUI_API bool          SecondChild(const char* str_id, const ImVec2& size_arg = ImVec2(0, 0), bool sub_tab = false, ImGuiWindowFlags extra_flags = NULL);
    // Content region
    // 

    IMGUI_API bool          Secondchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    bool Tabs(bool selected, ImTextureID image, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
